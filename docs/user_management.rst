...
* Администратор. Обладает полными правами на :ref:`управление видеокамерами <cameras>`, :ref:`базой данных персон <guests>`, событий, пользователями FindFace Security.
